    ...
    <Dialog>
      ...
      <DialogContent className="max-w-lg rounded-none p-6 sm:max-w-lg">
        ...
        <div className="space-y-4 text-[13px] leading-5">
          <section><h3 className="font-medium">Geometry</h3><p className="mt-1 text-muted-foreground">7,076 SPECTER title embeddings; separate seeded 2D and 3D UMAP projections. Positions are fixed within each dimension. Local proximity is more reliable than global distance.</p></section>
          ...
          <section><h3 className="font-medium">Selection</h3><p className="mt-1 text-muted-foreground">Groups retain the same paper IDs across lenses and dimensions. Hollow selected points lack the current lens data. Shared authors use exact names, not disambiguated identities.</p></section>
